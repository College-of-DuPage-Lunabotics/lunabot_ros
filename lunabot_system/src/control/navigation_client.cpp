...
private:
  ...
  void send_first_goal()
  {
    ...
    goal_pose.position.x = initial_x_ + 3.0;
  ...
  void odom_callback(const nav_msgs::msg::Odometry::SharedPtr msg)
  {
    ...
    if (aligning_)
    {
      ...
      {
        RCLCPP_INFO_ONCE(this->get_logger(), "\033[1;36mALIGNING TO CONSTRUCTION ZONE...\033[0m");
        twist_msg.angular.z = 0.2 * yaw_error / std::abs(yaw_error);
        cmd_vel_publisher_->publish(twist_msg);
      }
      else
      {
        RCLCPP_INFO_ONCE(this->get_logger(), "\033[1;32mCONSTRUCTION ZONE ALIGNMENT SUCCESS!\033[0m");
    ...
    if (moving_backward_ && !aligning_)
    {
      ...
      {
        RCLCPP_INFO_ONCE(this->get_logger(), "\033[1;32mCONSTRUCTION ZONE GOAL SUCCESS!\033[0m");
        auto twist_msg = geometry_msgs::msg::Twist();
