...
void readParameters(std::shared_ptr<rclcpp::Node> & nh)
{
  ...
  try {
    ...
    nh->declare_parameter<std::string>("publish.odom_frame_id", odom_frame_id);
    nh->get_parameter("publish.odom_frame_id", odom_frame_id);

    nh->declare_parameter<std::string>("publish.base_frame_id", base_frame_id);
    nh->get_parameter("publish.base_frame_id", base_frame_id);
